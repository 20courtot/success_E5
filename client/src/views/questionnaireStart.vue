      ...
      >
        <div class="card" style="width: 300px">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              Il y a {{ selected.countQuestion }} questions. <br> Et vous avez {{selected.questionnaire_info.time}} minutes.
            </p>
  ...
  methods: {
    show_btn_fonction() {
      ...
      setTimeout(
        function () {
          ...
          fetch("http://10.0.52.11:3000/success/countQuestion", requestOpt)
            .then((response) => response.text())
            // Sucess
            .then((result) => {
    ...
    get_questionnaire() {
          const requestOpt = { method: "POST",
            ...
            headers: { "Content-type": "application/json; charset=UTF-8" }, };
      fetch("http://10.0.52.11:3000/success/getPassed_questionnairesList", requestOpt)
        .then((response) => response.text())
        // Sucess
        .then((response) => {
