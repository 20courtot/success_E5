  ...
  methods: {
    nextQuest(statut){
      ...
      if(statut == "vrai"){
        ...
        fetch("http://10.0.52.11:3000/success/updateAns", requestOpt)
    ...
    go_correct(){
      ...
      if(this.selected.AnsList && this.tik == this.selected.AnsList.length){
        ...
        fetch("http://10.0.52.11:3000/success/updatePassedQuestionnaire", requestOpt)
          .then((response) => response.text())
          .catch((error) => {
            console.log("error", error);
          });
        ...
        fetch(
          "http://10.0.52.11:3000/success/getStudenttocorrect",requestOpt_info
        )
          .then((response) => response.text())
          // Sucess
          .then((result) => {
        ...
        if(this.tik == 0){
          ...
          fetch(
            "http://10.0.52.11:3000/success/getAnswertoCorrectList",
            requestOpt_info
          )
            .then((response) => response.text())
            // Sucess
      ...
      function () {
        ...
        fetch(
        "http://10.0.52.11:3000/success/getQuestion",
        requestOpt_infob
      )
        .then((response) => response.text())
        // Sucess
    ...
    show_btn_fonction() {
      ...
      setTimeout(
        function () {
          ...
          fetch(
            "http://10.0.52.11:3000/success/getQuestionnaire",
            requestOpt_info
          )
            .then((response) => response.text())
            // Sucess
