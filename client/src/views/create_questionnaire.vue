  ...
  <div class="createQuestionnaire">
    ...
    >
      <div class="mb-3">
        ...
        />
        <br/>
        <label for="time" class="form-label">Limite de temps pour passer le questionnaire:</label>
        <input type="number" v-model="time" id="time" class="form-control" placeholder="Temps en min"/>
        <br />
...
export default {
  ...
  methods: {
    ...
    send_questionnaire() {
      ...
      fetch("http://10.0.52.11:3000/success/createQuestionnaire", requestOpt)
        .then((response) => response.text())
        .then((result) => {
    ...
    send_question() {
      ...
      fetch("http://10.0.52.11:3000/success/createQuestion", requestOpt)
        .then((response) => response.text())
        .catch((error) => {
          console.log("error", error);
        });
