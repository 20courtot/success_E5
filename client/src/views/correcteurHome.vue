...
export default {
  ...
  methods: {
    stats(){
      ...
      fetch("http://10.0.52.11:3000/success/getStatQuest", requestOptc)
      ...
      fetch("http://10.0.52.11:3000/success/getstat", requestOptb)
        .then((response) => response.text())
        .then((result) => {
          this.taux = result;
        })
      ...
      fetch("http://10.0.52.11:3000/success/countQuestionnaire", requestOpt)
        .then((response) => response.text())
        .then((result) => {
